...
class Poi(models.Model):
    ...
    # Relationships
    znacka  = models.ForeignKey(Znacka, limit_choices_to = {'status__show': 'True'}, verbose_name=u"značka", help_text="Zde vyberte ikonu, která se zobrazí na mapě.", related_name="pois")
