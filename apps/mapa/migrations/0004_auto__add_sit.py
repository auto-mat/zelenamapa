...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sit'
        db.create_table(u'mapa_sit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('poi', self.gf('django.db.models.fields.related.OneToOneField')(related_name='sit', unique=True, to=orm['mapa.Poi'])),
            ('sit_id', self.gf('django.db.models.fields.IntegerField')(default=0, unique=True)),
            ('sit_id_um', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('sit_rc', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('sit_lokalita', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'mapa', ['Sit'])


    def backwards(self, orm):
        # Deleting model 'Sit'
        db.delete_table(u'mapa_sit')
